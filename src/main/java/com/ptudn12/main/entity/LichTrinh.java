...
public class LichTrinh {
	...
	public LichTrinh(TuyenDuong tuyen, Tau tau, LocalDateTime ngayGioKhoiHanh) {
		...
		this.tongSoGhe = tau != null ? /* tau.getSoLuongChoNgoi() */ 666 : 0;
	...
	/**
	 * Tạo mã lịch trình theo format: DiemDi_DiemDen_NgayDi_STT Ví dụ:
	 * SaiGon_HaNoi_27092025_1
	 */
	...
	public String toString() {
		return "LichTrinh{" + "maLichTrinh='" + maLichTrinh + '\'' + ", tau=" + (tau != null ? tau.getMacTau() : "null")
				...
				+ ngayGioKhoiHanh + ", ngayGioDen=" + ngayGioDen + ", giaCoBan=" + giaCoBan + ", soGheTrong="
				+ soGheTrong + "/" + tongSoGhe + ", trangThai="
